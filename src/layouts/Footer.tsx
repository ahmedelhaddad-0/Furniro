...
export default function Footer() {
  ...
  return (
    <footer className="w-full px-4 bg-white border-t border-[#000000]/10">
      <div className="w-full max-w-360 mx-auto py-10 md:py-20.75 flex flex-col justify-between">
        <div className="flex flex-col lg:flex-row justify-between gap-10 lg:gap-8 pb-10 md:pb-12">
          <div className="flex flex-col">
            ...
            <p className="text-[#9F9F9F] text-sm sm:text-base leading-relaxed mt-6 md:mt-21.5">
              400 University Drive Suite 200 Coral Gables, FL 33134 USA
            </p>
          </div>

          {/* Right Side: Big container with Links, Help, and Newsletter */}
          <div className="flex flex-col md:flex-row justify-between gap-10 lg:gap-12 xl:gap-18 grow lg:max-w-187.5 xl:max-w-195">
            {/* Left side of right container: Links & Help side-by-side with max-w-[352px] */}
            <div className="w-full max-w-88 flex justify-between gap-8">
              {/* Links Div */}
              <div className="flex flex-col">
                <span className="text-[#9F9F9F] font-medium text-sm md:text-base">
                  Links
                </span>
                <div className="mt-6 md:mt-19.75 flex flex-col gap-6 md:gap-11.5">
                  {navLinks.map((link) => (
                    <Link
                      key={link.name}
                      to={link.path}
            ...
            <div className="flex flex-col">
              ...
              <div className="mt-6 md:mt-19.25">
                <form
                ...
                >
                  <input
                    ...
                    className="border-b border-[#000000] pb-1 text-xs sm:text-sm text-black placeholder:text-[#9F9F9F] bg-transparent focus:outline-none w-full sm:w-45 md:w-50 transition-colors"
                  />
                  <button
                    type="submit"
        ...
        <div className="border-t border-[#D9D9D9] h-15 flex items-center text-[#000000] text-xs sm:text-sm md:text-base">
